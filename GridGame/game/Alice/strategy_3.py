"""
This file contains a strategy for Alice on a 3*n grid with 4 colors.
It guarantees that Alice will never lose on this type of grid.
It checks the last move of Bob and answers accordingly. 
"""
